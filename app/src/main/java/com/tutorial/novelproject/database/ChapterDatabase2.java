...
public class ChapterDatabase2 extends SQLiteOpenHelper {
    private static final int VERSION = 1;
    private static final String DATABASE_NAME = "Novel.db";
    private static final String TABLE_CHAPTER = "chapter2";
    private static final String TABLE_CHAPTER_CONTENT = "chapter_content2";
    ...
    public ChapterDatabase2(@Nullable Context context, @Nullable SQLiteDatabase.CursorFactory factory) {
